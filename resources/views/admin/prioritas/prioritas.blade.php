        ...
        <div class="row">
                    ...
                    <div class="card-body p-0">
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    <div class="d-flex flex-column align-items-center">
                                                        ...
                                                        @endphp
                                                        <span class="badge bg-{{$bg}}" style="font-size:0.6rem">Skor:
                                                            {{ $skor }}</span>
                                                    </div>
                                                </td>
                        ...
                        <div class="card-footer bg-light small text-muted border-top">
                            <ul class="mb-0 ps-3">
                                ...
                                <li><strong class="text-info">C2 :</strong> Jenis kejahatan yang paling sering
                                    terjadi diwilayah kecamatan (dikonversi ke Skor).</li>
                                <li><strong class="text-danger">C3 :</strong> Rata-rata kerugian materiil (Rupiah) per
                                    kasus.</li>
                                <li><strong class="text-success">C4 :</strong> Data kepadatan penduduk (Jiwa/km²).
                                </li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-3 form-group">
                                        ...
                                        <select class="form-select form-select-sm" name="impacts[]">
                                            <option value="1" {{ ($old_inputs['impacts'][0] ?? 1) == 1 ? 'selected' : '' }}>
                                                Benefit</option>
                                            <option value="-1" {{ ($old_inputs['impacts'][0] ?? 1) == -1 ? 'selected' : '' }}>Cost
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-3 form-group">
                                        ...
                                        <select class="form-select form-select-sm" name="impacts[]">
                                            <option value="1" {{ ($old_inputs['impacts'][1] ?? 1) == 1 ? 'selected' : '' }}>
                                                Benefit</option>
                                            <option value="-1" {{ ($old_inputs['impacts'][1] ?? 1) == -1 ? 'selected' : '' }}>Cost
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-3 form-group">
                                        ...
                                        <select class="form-select form-select-sm" name="impacts[]">
                                            <option value="-1" {{ ($old_inputs['impacts'][2] ?? -1) == -1 ? 'selected' : '' }}>
                                                Cost</option>
                                            <option value="1" {{ ($old_inputs['impacts'][2] ?? -1) == 1 ? 'selected' : '' }}>
                                                Benefit</option>
                                        </select>
                                    ...
                                    <div class="col-md-3 form-group">
                                        ...
                                        <select class="form-select form-select-sm" name="impacts[]">
                                            <option value="1" {{ ($old_inputs['impacts'][3] ?? 1) == 1 ? 'selected' : '' }}>
                                                Benefit</option>
                                            <option value="-1" {{ ($old_inputs['impacts'][3] ?? 1) == -1 ? 'selected' : '' }}>Cost
                                            </option>
                                        </select>
                                    </div>
                                </div>
            ...
            @if (isset($hasil_topsis))
                                        ...
                                        @foreach($final as $k => $res)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($k <= 5) <span class="badge bg-warning text-dark">Prioritas
                                                        Sedang</span>
                ...
                <div class="col-12 text-center mb-4">
                    <button class="btn btn-sm btn-outline-secondary shadow-sm" type="button" data-bs-toggle="collapse"
                        data-bs-target="#detailMatriks">
                ...
                <div class="collapse col-12" id="detailMatriks">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="card shadow">
                                <div class="card-header bg-light">
                                    <h6 class="mb-0 fw-bold small">1. Matriks Keputusan Awal (X)</h6>
                                </div>
                                <div class="card-body p-0">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="card shadow">
                                <div class="card-header bg-light">
                                    <h6 class="mb-0 fw-bold small">2. Matriks Normalisasi (R)</h6>
                                </div>
                                <div class="card-body p-0">
                                    <div class="table-responsive" style="max-height: 300px">
                                        <table class="table table-sm table-bordered text-center text-xs mb-0">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="card shadow">
                                <div class="card-header bg-light">
                                    <h6 class="mb-0 fw-bold small">3. Matriks Normalisasi Terbobot (Y)</h6>
                                </div>
                                <div class="card-body p-0">
                                    <div class="table-responsive" style="max-height: 300px">
                                        <table class="table table-sm table-bordered text-center text-xs mb-0">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="card shadow">
                                <div class="card-header bg-light">
                                    <h6 class="mb-0 fw-bold small">4. Solusi Ideal Positif & Negatif</h6>
                                </div>
                                <div class="card-body p-0">
                                    <div class="table-responsive">
                                        <table class="table table-sm table-bordered text-center text-xs mb-0">
                                            ...
                                            <tbody>
                                                <tr class="table-success fw-bold">
                                                    <td>A+ (Positif)</td>
                                                    @foreach($hasil_topsis['ideal_positive'] as $val)<td>
                                                    {{ number_format($val, 4) }}</td>@endforeach
                                                </tr>
                                                <tr class="table-danger fw-bold">
                                                    <td>A- (Negatif)</td>
                                                    @foreach($hasil_topsis['ideal_negative'] as $val)<td>
                                                    {{ number_format($val, 4) }}</td>@endforeach
                                                </tr>
                                            </tbody>
                                        </table>
